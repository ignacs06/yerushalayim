# -*- coding: utf-8 -*-
"""
Created on Thu Feb  5 23:46:01 2026
...
plt.errorbar(i, bt, yerr=error_t, fmt='o', xerr=error_a, ms=1, color='red',ecolor='black',label='Barras de error')
...
plt.errorbar(nesp, bst, yerr=errorbst, fmt='o', ms=1, color='red',ecolor='black',label='Barras de error')
plt.xlabel(r'$N_{espiras}$ ', fontsize=12)
plt.ylabel(r'$B$ (T)', fontsize=12)
plt.legend()
plt.show()
...
plt.figure()
plt.grid(True)
plt.plot(carmen,bquince,'o',ms=3,label='Datos experimentales')
plt.errorbar(carmen, bquince, yerr=dB3(carmen), fmt='o', ms=1, color='red',ecolor='black',label='Barras de error')
plt.plot(carmenlinspace,B3(carmenlinspace),linestyle='--',color='skyblue',label='Datos teóricos')
plt.ylabel(r'$B$ (T)', fontsize=12)
...
plt.plot(N6l,netanyahu[1]+netanyahu[0]*N6l,linestyle='--',label='Regresión experimental')
plt.errorbar(N6,xi(0.03,f6,N6)[0],xerr=10,yerr=xi(0.03,f6,N6)[1],fmt='o',ms=1,color='blue',ecolor='black')
